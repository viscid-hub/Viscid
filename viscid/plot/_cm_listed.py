"""Here are the 4 new sequential colormaps from matplotlib 1.5

The colormap data is a copy of,
https://github.com/matplotlib/matplotlib/blob/master/lib/matplotlib/_cm_listed.py
as of commit f3e0bfb923978af50d099c903099392d14e7816c
"""
...
try:
    ...
    for (name, data) in ((u'magma', _magma_data),
                         (u'inferno', _inferno_data),
                         (u'plasma', _plasma_data),
                         (u'viridis', _viridis_data),
                         (u'cividis', _cividis_data),
                         (u'twilight', _twilight_data),
                         (u'twilight_shifted', _twilight_shifted_data),
                         ):
