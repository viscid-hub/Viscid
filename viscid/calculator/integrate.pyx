...
cdef int _c_euler1(real_t[:,:,:,:] s, real_t[:] crdz, real_t[:] crdy,
    ...
    vx = _c_trilin_interp[real_t](s[...,0], crdz, crdy, crdx, x, start_inds)
    vy = _c_trilin_interp[real_t](s[...,1], crdz, crdy, crdx, x, start_inds)
    vz = _c_trilin_interp[real_t](s[...,2], crdz, crdy, crdx, x, start_inds)
...
cdef int _c_rk2(real_t[:,:,:,:] s, real_t[:] crdz, real_t[:] crdy,
    ...
    v0[2] = _c_trilin_interp[real_t](s[:,:,:,0], crdz, crdy, crdx, x0, start_inds)
    v0[1] = _c_trilin_interp[real_t](s[:,:,:,1], crdz, crdy, crdx, x0, start_inds)
    v0[0] = _c_trilin_interp[real_t](s[:,:,:,2], crdz, crdy, crdx, x0, start_inds)
    ...
    v1[2] = _c_trilin_interp[real_t](s[:,:,:,0], crdz, crdy, crdx, x1, start_inds)
    v1[1] = _c_trilin_interp[real_t](s[:,:,:,1], crdz, crdy, crdx, x1, start_inds)
    v1[0] = _c_trilin_interp[real_t](s[:,:,:,2], crdz, crdy, crdx, x1, start_inds)
