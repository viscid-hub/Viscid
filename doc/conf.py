# -*- coding: utf-8 -*-
#
# Viscid documentation build configuration file, created by
...
project = u'Viscid'
copyright = u'2015, Kristofor Maynard'
...
def get_viscid_version(init_py):
    with io.open(init_py, 'r', encoding='utf-8') as f:
        ...
        for line in f:
            ...
            if m:
                return m.groups()[1]
        raise RuntimeError("Could not find '__version__ = ...' in <{0}>. "
                           "Is this really viscid's __init__.py?".format(init_py))
...
latex_documents = [
  ('index', 'Viscid.tex', u'Viscid Documentation',
   u'Kristofor Maynard', 'manual'),
]
...
man_pages = [
    ('index', 'viscid', u'Viscid Documentation',
     [u'Kristofor Maynard'], 1)
]
...
texinfo_documents = [
  ('index', 'Viscid', u'Viscid Documentation',
   u'Kristofor Maynard', 'Viscid', 'One line description of project.',
   'Miscellaneous'),
]
